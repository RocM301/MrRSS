...
const zh: TranslationMessages = {
  ...
  setting: {
    ...
    content: {
      ...
      mtranTranslate: 'MTranServer（本地）',
      mtranEndpoint: 'MTranServer 地址',
      mtranEndpointDesc: '你自建的 MTranServer 地址，例如 http://192.168.1.100:8989',
      mtranToken: 'MTranServer 令牌',
      mtranTokenDesc: '可选的 API 令牌（未设置 MT_API_TOKEN 则留空）',
      mtranTokenPlaceholder: '可选',
